...
AS $$
DECLARE
  project_url TEXT := 'https://thyqmpnkubqhsumriktl.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRoeXFtcG5rdWJxaHN1bXJpa3RsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMjE2NTM1NSwiZXhwIjoyMDI3NzQxMzU1fQ.IWXuqKF9xlk3EN2OBOynED-o-7bZykvqwjehAyXaHCw'; -- full access needed for http request to storage
